...
Note: the tweet-to-quote import pipeline (features 002 and 003) was a one-time
event. Its scripts and the local Twitter archive have been removed;
`app/data/quotes.json` is now maintained by hand. Speaker names must match
`app/data/list-of-characters.txt` — see CONTRIBUTING.md.
